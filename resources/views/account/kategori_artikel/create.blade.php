        ...
        <div class="section-body">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('account.Kategori-Artikel.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="kategori" value="{{ old('kategori') }}" placeholder="Masukkan Kategori Artikel" class="form-control" required>
                                    </div>
                                    @error('kategori')
