      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                <label style="color: red;">KEKURANGAN PEMBAYARAN</label>
                <div class="input-group" style="color: red;">
                  <div class="input-group-prepend">
                    <span class="input-group-text" style="color: red; border-color: red;">Rp.</span>
                  </div>
                  <input style=" color: red; border-color: red;" type="text" name="kekurangan_pembayaran" id="kekurangan_pembayaran" value="{{ old('kekurangan_pembayaran', number_format($penyewaan->kekurangan_pembayaran, 0, ',', '.')) }}" class="form-control" readonly>
                </div>
              </div>
            </div>
          ...
          <div class="col-md-12">
            <div class="form-group">
              ...
              <input type="text" name="total" style="border-color: black; font-weight: bold;" value="{{ old('total', 'Rp ' . number_format($penyewaan->total, 0, ',', '.')) }}" class="form-control" readonly>
              @error('total')
              <div class="invalid-feedback" style="display: block">
                {{ $message }}
              </div>
