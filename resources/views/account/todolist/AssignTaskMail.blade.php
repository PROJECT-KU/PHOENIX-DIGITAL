                        ...
                        <center>
                            <div class="card mt-5 mb-5" style="width: 35rem;">
                                ...
                                <div class="card-body">
                                    ...
                                    <p style="font-size: 15px;">Anda baru saja mendapatkan Assign Task Baru, berikut rinciannya:</p>
                                    <div class="card_dalam" style="display: flex; justify-content: space-between; flex-wrap: wrap;">
                                        ...
                                        <div class="card-body mobile" style="color: black; text-align: left; flex: 1; margin-right: 25px; margin-left:180px;">
                                            <div style="text-align: right;">
                                                <p>{{ strtoupper($todolist->id_task) }}</p>
                                                <p>{{ strftime('%d %B %Y', strtotime($todolist->tanggal_assign)) }}</p>
                                                <p>{{ strftime('%d %B %Y', strtotime($todolist->tanggal_deadline)) }}</p>
                                                <p>{{ $todolist->prioritas_task }}</p>
                                                <p>{{ $todolist->judul_task }}</p>
                                            </div>
                                        </div>
                                    </div>
